...
[![CI](https://git.baer.one/phbaer/ha-birthday-calendar/actions/workflows/build-and-test.yaml/badge.svg)](https://git.baer.one/phbaer/ha-birthday-calendar/actions/workflows/build-and-test.yaml)
